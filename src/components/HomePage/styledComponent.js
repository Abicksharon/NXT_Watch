...
export const BannerNxtlogo = styled.img` height: 25px;
margin-top:10px;
`

export const BannerTopCont = styled.div` height: 30px;
width:100%;
display: flex;
  flex-direction: row;
...
export const CloseButton = styled.button` height: 26px;
width:26px;
display: flex;
...
`
export const BannerSectionClose = styled(MdClose)` height: 27px;
`
export const BannerText = styled.p` font-size:14px;
  font-family: Roboto;
  font-weight:500;
color:#1e293b;
`
export const BannerBtn = styled.button` font-size:10px;
  font-family: Roboto;
color:#1e293b;
height:26px;
width:85px;
