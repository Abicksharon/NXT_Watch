...
export const NavContainer = styled.div` height:100%;
  width:17%;
...
cursor:pointer;
  ...
  `
export const TrendingLink = styled(HomeLink)`  text-decoration: none;
`
...
export const HomeIcon = styled(TiHome)`font-size:14px;
margin:0px 20px 0px 25px;
color:${props => (props.isActive ? '#ff0000' : '#606060')};
  `

export const TrendingIcon = styled(HiFire)`font-size:14px;
color:${props => (props.isActive ? '#ff0000' : '#606060')};
margin:0px 20px 0px 25px;

  `

export const GamingIcon = styled(SiYoutubegaming)`font-size:14px;
color:${props => (props.isActive ? '#ff0000' : '#606060')};
margin:0px 20px 0px 25px;

  `
export const SavedVideosIcon = styled(CgPlayListAdd)`font-size:14px;
color:${props => (props.isActive ? '#ff0000' : '#606060')};
margin:0px 20px 0px 25px;
...
export const ContactIconsCont = styled.div` height:30px;
  width:100%;
